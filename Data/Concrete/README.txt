...
The image set has been modified from the original to organize a subset of the images for the course exercises.  The full image set can be found at the URL referenced below.
