...
The image set has been modified from the original to select a subset of images for registration exercises in the course.  The full image set can be found at the URL referenced below.


Original Data Source: https://data.mendeley.com/datasets/5y9wdsg2zt/2
