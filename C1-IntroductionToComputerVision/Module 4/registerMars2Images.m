function [MOVINGREG] = registerMars2Images(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 09-Dec-2024
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',586.633301,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',586.633301,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',51.000977,'MaxRatio',0.510010);
