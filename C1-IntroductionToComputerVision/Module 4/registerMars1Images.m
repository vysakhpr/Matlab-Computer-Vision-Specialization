function [MOVINGREG] = registerMars1Images(MOVING,FIXED)
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',620.800781,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',620.800781,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',62.158203,'MaxRatio',0.621582);
