...
% Auto-generated by registrationEstimator app on 05-Dec-2024
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',578.112793,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',578.112793,'NumOctaves',4,'NumScaleLevels',6);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',83.603516,'MaxRatio',0.836035);
